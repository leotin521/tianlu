(function(a) {
	a.alerts = {
		...
		_overShow : function(d, c) {
			...
			a("body")
					.append(
							'<div id="over_container" style="display:none"><div id="over_message"></div></div>');
			a("#over_message").text(d).html(
					a("#over_message").text().replace(/\n/g, "<br />"));
		...
		_overReposition : function() {
			var c = 4;
			var b = ((a(window).width() / 2) - (a("#over_container")
					.outerWidth() / 2))
		...
		_show : function(j, b, k, g, m, l, c, f, n) {
			...
			a("body")
					.append(
							'<div id="popup_container" style="display:none"><h1  id="popup_title"></h1><em id="ctl"></em><em id="cbl"></em><em id="ctr"></em><em id="cbr"></em><span id="popup_close"></span><div id="popup_content"><div id="popup_message"></div></div></div>');
			if (a.alerts.dialogClass) {
				a("#popup_container").addClass(a.alerts.dialogClass)
			}
			var i = (a.browser.msie && parseInt(a.browser.version) <= 6) ? "absolute"
					: "fixed";
			...
			case "prompt":
				a("#popup_message")
						.append(
								'<input type="password" size="30" id="popup_prompt" />')
						.after(
								'<div id="popup_panel"><input type="button" value="'
										+ a.alerts.okButton
										+ '" id="popup_ok" /> <input type="button" value="'
		...
		_overlay : function(b) {
			...
			case "show":
				...
				a("BODY")
						.append(
								'<div id="popup_overlay"><iframe src="" width="100%" height="100%"></iframe></div>');
				a("#popup_overlay").css({
					position : "absolute",
					zIndex : 99998,
					top : "0px",
		...
		_reposition : function() {
			var c = ((a(window).height() / 2) - (a("#popup_container").height() / 2))
					+ a.alerts.verticalOffset;
			var b = ((a(window).width() / 2) - (a("#popup_container").width() / 2))
					+ a.alerts.horizontalOffset;
			if (c < 0) {
				c = 0
			}
