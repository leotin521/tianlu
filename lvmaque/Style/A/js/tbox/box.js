...
jQuery.extend(ui.box, {
    ...
    WRAPPER:    "<table cellspacing='0' id='tsbox' cellpadding='0' border='0' style='display:none;z-Index:999;padding-top:80px;top:-30px!important' class='boxy-wrapper'>" +
    ...
    _u: function() {
	 ...
	 _cssForOverlay: function() {
		...
		center: function(axis) {
    	    ...
    	    //if (!axis || axis == 'y') this.centerAt(null, o[1] + v.height / 2);//控制后台弹出层居上高度
    	    return this;
    	},
