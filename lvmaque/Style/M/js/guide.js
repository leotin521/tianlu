...
function showSearchTip(){
	...
	var searchTipInner = "<div class='tipbox' id='step2'><span class='tipboxBtn' onclick='hideTip()'>关闭</span><a  href='#stepflow03' class='tipboxNextbtn' onclick='nextStep(3)'>下一步</a><ol class='progress'><li class='on'></li><li></li><li></li><li></li></ol></div>";
		searchTipInner += "<div class='tipbox' id='step3'><span class='tipboxBtn' onclick='hideTip()'>关闭</span><a href='#stepflow03' class='tipboxNextbtn' onclick='nextStep(4)'>下一步</a><ol class='progress'><li></li><li class='on'></li><li></li><li></li></ol></div>";
		searchTipInner += "<div class='tipbox' id='step4'><div class='tipword'></div><span class='tipboxBtn' onclick='hideTip();noShow()'>进入账户</span></div>";
		//searchTipInner += "<div class='tipbox' id='step4'><span class='tipboxBtn' onclick='hideTip()'>关闭</span><span class='tipboxNextbtn' onclick='hideTip();noShow()'></span><div class='notip'><input type='checkbox' id='notip' /><label for='notip'>不再提示</label></div></div>";

	var switchBtn = "<div class='tipSwitchAnimate tipSwitch' style='display:none; left:410px; top:353px;'></div>";	
	if($("#searchTip").length == 0){
		$("#guide-step").before("<div id='searchTipBg' style='width:100%; height:100%; left:0px; top:0px; z-index:999; background-color:#000; opacity:0.60; filter:alpha(opacity=60);position:"+ position +"'></div>");
		$("#guide-step").before("<div id='searchTip' style='left:56%; top:450px; z-index:1005; background-color:transparent; position:absolute;'>"+ searchTipInner +"</div>");
