...
function fileQueueError(file, errorCode, message){
    try {
		...
		var errorName = "";
		alert(SWFUpload.errorCode_QUEUE_LIMIT_EXCEEDED);
		if (errorCode === SWFUpload.errorCode_QUEUE_LIMIT_EXCEEDED || SWFUpload.errorCode_QUEUE_LIMIT_EXCEEDED===undefined) {
...
function uploadSuccess(file,serverData) {
	try {
		...
		if (rgx.test(serverData)) {
			...
			var resarr = resarr.split(":");
			var imgid = resarr[0].replace(/[^0-9]/ig,"");
			var imgsrc = resarr[1];
