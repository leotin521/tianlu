...
class TenderListViewModel extends ViewModel {
	 public $viewFields = array(
		'BorrowInvestor'=>array('id','status','borrow_id','investor_uid','borrow_uid','investor_capital','investor_interest','receive_capital','receive_interest','substitute_money','expired_money','invest_fee','paid_fee','add_time'=>'invest_time','deadline','is_auto','reward_money','debt_time', 'debt_interest_rate','_type'=>'LEFT'),
		...
		'Members'=>array('user_name'=>'borrow_user','credits','_on'=>'Members.id=Borrow.borrow_uid','_type'=>'LEFT'),
