...
class MfieldsAction extends ACommonAction
{
    ...
    */
	...
	public function listdir(){
			...
			$sdir = $_REQUEST['s_dir']?htmlspecialchars($_REQUEST['s_dir'], ENT_QUOTES):'';
			
			$listdir = $_REQUEST['l_dir']?htmlspecialchars($_REQUEST['l_dir'], ENT_QUOTES):'';
	...
	protected function _buildtrfile($file,$currentdir,$filesize,$filetime,$id){
		...
		$tr = '<tr bgcolor="#FFFFFF" overstyle="on" align="left" id="line_'.$id.'">
				   <td>
				   <img src="__ROOT__/Style/A/images/ico/'.$ico.'" width="20px" height="20px"align="absbottom">'.$file.'
				   </td>
