<?php
   ...
   class ScanAction extends ACommonAction
   {
       ...
       */
       ...
       {   
           $info = FS('Webconfig/scan/scanconfig');
       ...
       {
           $scan_badfile = FS('Webconfig/scan/badfile');
       ...
       */
       public function updateConfig()
       {
           ...
           FS('scanconfig', $config, 'Webconfig/scan/');
       ...
       */
       ...
       {
           set_time_limit(600);
           $scan_list = FS('Webconfig/scan/scan_file_list');
           $scan_config = FS('Webconfig/scan/scanconfig');
       ...
       */
       public function fileCode()
       {
           ...
           $scan_list = FS('Webconfig/scan/scan_file_list');
           $scan_config = FS('Webconfig/scan/scanconfig');
           $badfiles = FS('Webconfig/scan/badfile');
       ...
       */
       public function fileFilter()
       {
           ...
           FS('scan_file_list', $list, 'Webconfig/scan/');
