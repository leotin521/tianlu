    ...
    */
    public function index()
    {
		...
		if(isset($_REQUEST['type_id']) && $_REQUEST['type_id']) {
           ...
           $this->assign('type_id', intval($_REQUEST['type_id']));  
		}
	...
	public function _doAddFilter($m){
	    ...
	    $m->art_info = htmlspecialchars($m->art_info, ENT_QUOTES);
	    $m->art_keyword = htmlspecialchars($m->art_keyword, ENT_QUOTES);
	    $m->art_content = $m->art_content;
	    $m->art_writer = htmlspecialchars($m->art_writer, ENT_QUOTES);
	    $m->art_url = htmlspecialchars($m->art_url, ENT_QUOTES);
